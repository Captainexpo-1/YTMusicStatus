...
class Payload:
    ...
    def set_activity(cls, pid: int = os.getpid(),
        ...
        if activity is None:
            ...
            if buttons:
                act_details["buttons"] = buttons

            activity_payload = remove_none(act_details)
            clear = False
        ...
        payload = {
            ...
            "args": {
                "pid": pid,
                "activity": activity_payload  # ✅ Use the cleaned + updated version
            },
